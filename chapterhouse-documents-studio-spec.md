...
## The 14 Document Types — Prompts & Forms
...
**Form fields:** `campaign_goal`, `target_brand`, `audience_segment` (reference customer-avatar.md), `offer`, `budget_range`, `test_variants` (number)
