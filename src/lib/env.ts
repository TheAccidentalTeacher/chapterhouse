...
const envSource = {
  ...
  // Image Generation (M4)
  STABILITY_AI_KEY: process.env.STABILITY_API_KEY ?? process.env.STABILITY_AI_KEY,
  REPLICATE_TOKEN: process.env.REPLICATE_API_TOKEN ?? process.env.REPLICATE_TOKEN,
  LEONARDO_API_KEY: process.env.LEONARDO_API_KEY ?? process.env.LEONARDO_AI_API_KEY,
