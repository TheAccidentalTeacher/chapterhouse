...
export const navigationGroups: NavigationGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        label: "Unread Triage",
        href: "/unread-triage",
        description: "AI triage for unread emails — classify, review, and bulk mark as read.",
        icon: MailOpen,
        tooltip: {
          summary: "Uses Claude Haiku to classify all unread emails across every account into three tiers — important, routine, and skip. Important emails stay unread by default; routine and skip are pre-selected for bulk mark-as-read. Run daily to stay on top of a high-volume inbox.",
          features: [
            "Three-tier classification: important, routine, and skip",
            "Important emails kept unread by default — uncheck to mark as read",
            "Routine and skip auto-selected for bulk mark-as-read",
            "Per-account breakdown with color-coded badges",
            "All/None toggles per section for quick adjustments",
            "Single-click to mark hundreds of emails as read",
          ],
          tips: [
            "Run first thing in the morning to triage overnight email",
            "Use All/None buttons to quickly flip a whole section",
            "After marking, run again to catch any new arrivals",
          ],
        },
        status: "live",
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Newspaper,
        tooltip: {
          summary: "Monthly AI-powered blog calendar generation, individual post drafting with full SEO, and one-click publishing to the NCHO Shopify store. Two content lanes: sales posts (product-linked) and authority posts (teacher expertise).",
          features: [
            "AI generates monthly calendar with ~8-10 posts (2/week + holidays)",
            "Two content lanes: sales (product-linked) and authority (teacher expertise)",
            "Full SEO: title, description, keywords, tags generated per post",
            "One-click draft generation with Claude Sonnet 4.6",
            "Direct publish to NCHO Shopify blog via GraphQL API",
          ],
          tips: [
            "Generate the calendar first, remove any topics you don't like, then save",
            "Draft posts one at a time — review each before generating the next",
            "First post target: April 15, 2026 (Tax Day)",
          ],
        },
        status: "live",
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: "Dreamer",
        href: "/dreamer",
        description: "Idea queue. Seeds wait here until you're ready to act.",
        icon: Star,
        tooltip: {
          summary: "Your dream and idea management system. Seeds (raw ideas) live here until Scott promotes them. Nothing auto-advances — every status change is deliberate. Earl can review your seed backlog and give honest assessments: promote, dismiss, hold, or merge. Archive recovers dismissed ideas. Kanban columns: Seeds → Active → Building → Shipped.",
          features: [
            "Kanban board: Seeds, Active, Building, Shipped columns",
            "One-click status moves between any column",
            "Edit text and notes inline — no page reload needed",
            "Earl AI Review: analyzes all seeds against May 2026 deadline and suggests promote/dismiss/hold",
            "Urgency scoring: now / soon / later / never per seed",
            "Archive drawer: archived and dismissed items preserved and recoverable",
            "Category tagging: general, product, curriculum, marketing, tech, ncho, somersschool, biblesaas",
            "Push API: insert_seed action adds seeds directly from external workspaces",
          ],
          tips: [
            "Add a seed, then ask Earl to review it — look for the amber suggestion card",
            "Click 'Apply' on an Earl suggestion to move the seed instantly",
            "Use 'Dismiss' to consciously set aside distractions — they stay in archive, not deleted",
            "Seeds added via chat AI's add_seed tool appear here automatically (Phase 5)",
          ],
        },
        status: "live",
      },
