...
3. SOMERSCHOOL / CURRICULUM PRODUCTION — Scott produces K-12 courses using AI pipelines. Advances in AI content generation, audio synthesis, image generation, or document production are directly relevant. SomersSchool is a standalone SaaS (off Epic Learning as of March 2026).
