...
| chapterhouse | TS + Python | 🔴 Active | Private ops brain — Council of the Unserious 5-pass curriculum factory (Gandalf→Data→Polgara→Earl→Beavis), job runner (QStash→Railway), n8n control panel, Council Mode chat (SSE), daily brief, research ingestion, national standards auto-alignment (CCSS-ELA/CCSS-M/NGSS/C3). Supabase Realtime + Anthropic + OpenAI. HTML/PDF/DOCX export. |
