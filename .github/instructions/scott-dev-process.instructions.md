...
2. Add a one-line summary to `email/.github/copilot-instructions.md` → `Last Updated` section
3. Re-run the workspace copy command for any active workspace that needs the fresh `copilot-instructions.md`
...
- **Brand guide workspace** — strategy/planning/documentation floor. Contains `production-pipeline-build-bible.md` (content production pipeline for CoursePlatform). Not a deployable app. Its artifacts feed into CoursePlatform and Chapterhouse. Groq approved for strategy work here.

---

*Last updated: March 22, 2026. Added: CLAUDE.md definition under Pre-Flight Reading; living spec / SCOTT DECIDES pattern under Step 4; Step 5 Session Close; Brand guide workspace entry in Repo-Specific Context.*
